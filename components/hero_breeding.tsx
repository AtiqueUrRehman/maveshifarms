export default function HeroBreeding() {
  return (
    <>
      <div
        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1>
                <span className="mt-1 block text-2xl tracking-tight font-extrabold sm:text-3xl xl:text-3xl inline text-gray-900">
                <span className="inline text-red-600"> MaveshiFarms </span> 
                is breeding top of the line (A+ category) animals of 
                <span className="inline text-yellow-500"> Makhi C</span>
                <span className="inline text-yellow-400">heen</span>
                <span className="inline text-yellow-500">a </span>
                breed for improved meat and milk production. 
                </span>
              </h1>
              &nbsp;
            ...
            <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
              ...
              <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                ...
                >
                  ...
                  <img className="w-full" src="hero_breeding.png" alt="" />
                </button>
              </div>
            </div>
          </div>
